...
Поле `prolong` в случае необходимости продлевает парсинг на то же время с момента вызова
...
## Места для доработок
- Сделать опциональный параметр `duration` установления продолжительности пасинга с момента вызова (как замена `prolong`)
